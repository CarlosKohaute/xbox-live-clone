...
-- AddForeignKey
ALTER TABLE "favorite" ADD CONSTRAINT "favorite_product__name_fkey" FOREIGN KEY ("product__name") REFERENCES "product"("name") ON DELETE RESTRICT ON UPDATE CASCADE;
